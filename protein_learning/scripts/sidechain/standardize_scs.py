...
if __name__ == "__main__":
    parser = ArgumentParser(description="standardize side chain pdbs after inference (For use on RX machines only)",  # noqa
                            formatter_class=ArgumentDefaultsHelpFormatter)

    parser.add_argument(
        '--method',
        help="root directory with method statistics"
    )
    parser.add_argument(
        '--steric_weight',
